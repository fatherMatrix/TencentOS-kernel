...
{
	/*
	 * pv_ops全局变量在声明时，将其设置为 native_queued_spin_lock_slowpath()
	 * kvm_spinlock_init()中，将其设置为 __pv_queued_spin_lock_slowpath()
	 */
...
{
	/*
	 * kvm_spinlock_init()中，将其设置为 __pv_queued_spin_unlock()
	 */
